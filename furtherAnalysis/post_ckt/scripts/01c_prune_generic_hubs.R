...
#
# Usage:
#   Rscript 01c_prune_generic_hubs.R <exposure> <outcome> <degree>
#   Rscript 01c_prune_generic_hubs.R Hypertension Alzheimers 3
#
# NOTE: Run 01a_calculate_centrality.R and 01b_node_removal_impact.R first
