...
cycle_dir <- get_s3_cycles_dir(exposure_name, outcome_name, degree)
images_dir <- file.path(cycle_dir, "plots")

# Create images directory
ensure_dir(images_dir)

print_header(paste0("Cycle Subgraph Visualization (Stage 3) - Degree ", degree), exposure_name, outcome_name)
