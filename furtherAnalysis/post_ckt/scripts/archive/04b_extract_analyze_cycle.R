...
output_dir <- get_s3_cycles_dir(exposure_name, outcome_name, degree)
...
print_header(paste0("Cycle Extraction and Subgraph Analysis (Stage 3) - Degree ", degree), exposure_name, outcome_name)
