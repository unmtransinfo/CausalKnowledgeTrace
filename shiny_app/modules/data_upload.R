...
#'
#' Iteratively removes leaf nodes (nodes with total degree = 1) from a DAG.
#' This function converts the dagitty object to igraph, removes leaves iteratively,
#' and converts back to dagitty format.
#'
#' @param dag_object dagitty object containing the DAG
#' @param preserve_exposure_outcome Logical. If TRUE, preserves exposure and outcome nodes even if they are leaves (default: TRUE)
#' @return List containing success status, message, cleaned DAG object, and statistics
#' @export
