            ...
            box(
                ...
                fluidRow(
                    column(4,
                        ...
                        h5("Squelch Thresholds (by degree)"),
                        numericInput(ns("min_pmids_degree1"),
                                   "Degree 1 Min PMIDs:",
                                   value = 10,
                                   min = 1,
                                   max = 1000,
                                   step = 1),
                        numericInput(ns("min_pmids_degree2"),
                                   "Degree 2 Min PMIDs:",
                                   value = 10,
                                   min = 1,
                                   max = 1000,
                                   step = 1),
                        numericInput(ns("min_pmids_degree3"),
                                   "Degree 3 Min PMIDs:",
                                   value = 10,
                                   min = 1,
                                   max = 1000,
        ...
        fluidRow(
            box(
                ...
                tags$ul(
                    ...
                    tags$li(strong("Degree 1/2/3 Min PMIDs:"), "Minimum number of PubMed articles required for relationships at each degree level"),
